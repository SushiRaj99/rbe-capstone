...
MAP_CONFIGS = { # TODO - the start and goal point configs within each map are placeholders that need to be updated!
    os.path.join(MAPS_DIR, 'corridors', 'corridors.yaml'): [
        dict(start_x=0.0, start_y=0.0, start_yaw=0.0, goal_x=1.0, goal_y=1.0, goal_yaw=1.0, xy_tolerance=0.25, yaw_tolerance=0.25),
        dict(start_x=0.0, start_y=0.0, start_yaw=0.0, goal_x=2.0, goal_y=2.0, goal_yaw=2.0, xy_tolerance=0.25, yaw_tolerance=0.25),
        dict(start_x=0.0, start_y=0.0, start_yaw=0.0, goal_x=3.0, goal_y=3.0, goal_yaw=3.0, xy_tolerance=0.25, yaw_tolerance=0.25)
    ],
