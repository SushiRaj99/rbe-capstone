...
\\section{Materials and Methods}\label{sec:pq_metrics}
    ...
    -----HIGH LEVEL TALK ABOUT GYMNASIUM ENVIRONMENT, NAV2 STACK, RL / PPO BUILD, REWARD FUNCTION??-----
    ...
    -----CODE FLOW / BREAKDOWN OF KEY FILES-----
        \subsubsection{Planner control & Episone Runner}
        These two ROS2 nodes (planner_controller.py and episode_runner.py) work in concert with eachother and act as the backbone for the episodic training
        ...
        The episode_runner node, as the name implise, runs a loop of episodes for both the untrained (benchmark) and trained (RL mode) path planners. It sets
